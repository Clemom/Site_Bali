document.querySelector(".retour a").addEventListener("click" , function (event){
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function chargerParcours(duree) {
      ...
      if (duree === "25jours"){
          jsonParcours ="https://raw.githubusercontent.com/Clemom/Site_Bali/main/Parcours_Ganesh/Parcours_Ganesh25.json";
      } else if (duree ==="20jours"){
          jsonParcours="https://raw.githubusercontent.com/Clemom/Site_Bali/main/Parcours_Ganesh/Parcours_Ganesh20.json";
      } else {
          jsonParcours="https://raw.githubusercontent.com/Clemom/Site_Bali/main/Parcours_Ganesh/Parcours_Ganesh15.json"
      }
